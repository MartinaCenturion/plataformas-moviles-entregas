...
function agregarApodo(persona, apodo) {
    // Crea una copia del objeto persona para no modificar el original
    let personaConApodo = { persona };
...
function sinDocumento(persona) {
    // Crea una copia del objeto persona sin el campo documento
...
function felizCumpleaños(persona) {
    // Crea una copia del objeto persona para no modificar el original
    let personaFelizCumpleaños = { persona };
    personaFelizCumpleaños.edad++;
    return personaFelizCumpleaños;
    // 
}
